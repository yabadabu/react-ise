...
// -----------------------------------------------------------------
export default class CompPiezasFacturasDetails extends React.Component {
    ...
    return (
      <div className="main_section">
        <CompSearchDB 
            ...
            fuzzySearchQuery="PiezasFacturasLike"
            exactSearchQuery="PiezasFacturaByID"
            queryTitle="Número de la Factura"
            />
        {entry}
      </div>
    );
...
CompPiezasFacturasDetails.propTypes = {
};
